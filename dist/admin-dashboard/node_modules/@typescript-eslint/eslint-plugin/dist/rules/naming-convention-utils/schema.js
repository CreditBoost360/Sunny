  ...
  return {
    ...
    properties: Object.assign(Object.assign({}, FORMAT_OPTIONS_PROPERTIES), {
      ...
      selector: {
        ...
        items: {
          type: 'string',
          enum: [...util.getEnumNames(enums_1.MetaSelectors), ...util.getEnumNames(enums_1.Selectors)]
        },
        additionalItems: false
      },
      modifiers: {
