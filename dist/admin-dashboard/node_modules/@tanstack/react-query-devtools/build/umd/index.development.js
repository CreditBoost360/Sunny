(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@tanstack/react-query')) : typeof define === 'function' && define.amd ? define(['exports', 'react', '@tanstack/react-query'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactQueryDevtools = {}, global.React, global.ReactQuery));
  ...
  // eslint-disable-next-line es5/no-es6-methods
  function (v) {
    return __spreadArray$1([], __read$1(v.values()));
  }, function (v) {
    return new Set(v);
  }), simpleTransformation(isMap, 'map', function (v) {
    return __spreadArray$1([], __read$1(v.entries()));
  }, function (v) {
    return new Map(v);
  ...
  var typedArrayRule = compositeTransformation(isTypedArray, function (v) {
    ...
    return __spreadArray$1([], __read$1(v));
  }, function (v, a) {
  ...
  var isDeep = function (object) {
    return isPlainObject$1(object) || isArray$1(object) || isMap(object) || isSet(object) || isInstanceOfRegisteredClass(object);
  };
