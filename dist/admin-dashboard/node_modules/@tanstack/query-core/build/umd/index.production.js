!function (t, e) {
  "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).QueryCore = {});
}(this, function (t) {
  "use strict";
  ...
  const s = "undefined" == typeof window || "Deno" in window;
  function i() {}
  function r(t) {
  ...
  function h(t, e) {
    ...
    return ("boolean" != typeof o || e.isStale() === o) && (void 0 === r || r === e.state.fetchStatus) && !(n && !n(e));
  }
  function c(t, e) {
    const {
      exact: s,
  ...
  function C(t, e, s) {
    return null != s.isDataEqual && s.isDataEqual(t, e) ? t : "function" == typeof s.structuralSharing ? s.structuralSharing(t, e) : !1 !== s.structuralSharing ? y(t, e) : e;
  }
  const P = new class extends e {
      constructor() {
        super(), this.setup = t => {
  ...
  function w(t) {
    return "online" !== (null != t ? t : "online") || Q.isOnline();
  }
  class F {
    constructor(t) {
  ...
  function D(t) {
    ...
    const o = new Promise((t, e) => {
      ...
      u = () => !P.isFocused() || "always" !== t.networkMode && !Q.isOnline(),
      h = i => {
        a || (a = !0, null == t.onSuccess || t.onSuccess(i), null == e || e(), s(i));
      },
      c = s => {
        a || (a = !0, null == t.onError || t.onError(s), null == e || e(), i(s));
      },
      l = () => new Promise(s => {
        e = t => {
          const e = a || !u();
      ...
      d = () => {
        ...
        Promise.resolve(e).then(h).catch(e => {
          var s, i;
          if (a) return;
          const o = null != (s = t.retry) ? s : 3,
            h = null != (i = t.retryDelay) ? i : M,
            f = "function" == typeof h ? h(n, e) : h,
            p = !0 === o || "number" == typeof o && n < o || "function" == typeof o && o(n, e);
          !r && p ? (n++, null == t.onFail || t.onFail(n, e), R(f).then(() => {
            if (u()) return l();
          }).then(() => {
            r ? c(e) : d();
          })) : c(e);
    ...
    return w(t.networkMode) ? d() : l().then(d), {
      promise: o,
      cancel: e => {
        a || (c(new F(e)), null == t.abort || t.abort());
      },
      continue: () => (null == e ? void 0 : e()) ? o : Promise.resolve(),
      cancelRetry: () => {
        r = !0;
      },
      continueRetry: () => {
  ...
  class U {
    ...
    scheduleGc() {
      this.clearGcTimeout(), r(this.cacheTime) && (this.gcTimeout = setTimeout(() => {
        this.optionalRemove();
      }, this.cacheTime));
    }
    updateCacheTime(t) {
  ...
  class I extends U {
    constructor(t) {
      super(), this.abortSignalConsumed = !1, this.defaultOptions = t.defaultOptions, this.setOptions(t.options), this.observers = [], this.cache = t.cache, this.logger = t.logger || A, this.queryKey = t.queryKey, this.queryHash = t.queryHash, this.initialState = t.state || function (t) {
        ...
        return {
          data: e,
          dataUpdateCount: 0,
          dataUpdatedAt: s ? null != i ? i : Date.now() : 0,
          error: null,
          errorUpdateCount: 0,
          errorUpdatedAt: 0,
          fetchFailureCount: 0,
    ...
    setData(t, e) {
      const s = C(this.state.data, t, this.options);
    ...
    cancel(t) {
      ...
      return null == (e = this.retryer) || e.cancel(t), s ? s.then(i).catch(i) : Promise.resolve();
    }
    destroy() {
    ...
    fetch(t, e) {
      ...
      var h;
      (o(u), null == (s = this.options.behavior) || s.onFetch(u), this.revertState = this.state, "idle" === this.state.fetchStatus || this.state.fetchMeta !== (null == (i = u.fetchOptions) ? void 0 : i.meta)) && this.dispatch({
        type: "fetch",
        meta: null == (h = u.fetchOptions) ? void 0 : h.meta
      });
      const c = t => {
        var e, s, i, r;
        (E(t) && t.silent || this.dispatch({
          type: "error",
          error: t
        }), E(t)) || (null == (e = (s = this.cache.config).onError) || e.call(s, t, this), null == (i = (r = this.cache.config).onSettled) || i.call(r, this.state.data, t, this));
      ...
      return this.retryer = D({
        ...
        onSuccess: t => {
          var e, s, i, r;
          void 0 !== t ? (this.setData(t), null == (e = (s = this.cache.config).onSuccess) || e.call(s, t, this), null == (i = (r = this.cache.config).onSettled) || i.call(r, t, this.state.error, this), this.isFetchingOptimistic || this.scheduleGc(), this.isFetchingOptimistic = !1) : c(new Error(this.queryHash + " data is undefined"));
        },
        onError: c,
        onFail: (t, e) => {
          this.dispatch({
        ...
        switch (t.type) {
          ...
          case "fetch":
            return {
              ...
              fetchStatus: w(this.options.networkMode) ? "fetching" : "paused",
              ...(!e.dataUpdatedAt && {
                error: null,
                status: "loading"
              })
          ...
          case "error":
            const r = t.error;
            return E(r) && r.revert && this.revertState ? {
              ...this.revertState,
              fetchStatus: "idle"
            } : {
              ...e,
  ...
  class K extends e {
    ...
    find(t, e) {
      const [s] = u(t, e);
      return void 0 === s.exact && (s.exact = !0), this.queries.find(t => h(s, t));
    }
    findAll(t, e) {
      const [s] = u(t, e);
      return Object.keys(s).length > 0 ? this.queries.filter(t => h(s, t)) : this.queries;
    }
    notify(t) {
      x.batch(() => {
        this.listeners.forEach(({
  ...
  class T extends U {
    constructor(t) {
      super(), this.defaultOptions = t.defaultOptions, this.mutationId = t.mutationId, this.mutationCache = t.mutationCache, this.logger = t.logger || A, this.observers = [], this.state = t.state || L(), this.setOptions(t.options), this.scheduleGc();
    }
    setOptions(t) {
      this.options = {
        ...this.defaultOptions,
    ...
    async execute() {
      ...
      try {
        ...
        if (!e) {
          ...
          const t = await (null == (d = (f = this.options).onMutate) ? void 0 : d.call(f, this.state.variables));
        ...
        try {
          var p, y, v, m, b, g, O, R;
          throw await (null == (p = (y = this.mutationCache.config).onError) ? void 0 : p.call(y, t, this.state.variables, this.state.context, this)), await (null == (v = (m = this.options).onError) ? void 0 : v.call(m, t, this.state.variables, this.state.context)), await (null == (b = (g = this.mutationCache.config).onSettled) ? void 0 : b.call(g, void 0, t, this.state.variables, this.state.context, this)), await (null == (O = (R = this.options).onSettled) ? void 0 : O.call(R, void 0, t, this.state.variables, this.state.context)), t;
        } finally {
          this.dispatch({
            type: "error",
            error: t
        ...
        switch (t.type) {
          ...
          case "loading":
            return {
              ...
              failureReason: null,
              error: null,
              isPaused: !w(this.options.networkMode),
              status: "loading",
  ...
  class k extends e {
    ...
    find(t) {
      return void 0 === t.exact && (t.exact = !0), this.mutations.find(e => c(t, e));
    }
    findAll(t) {
      return this.mutations.filter(e => c(t, e));
    }
    notify(t) {
      x.batch(() => {
        this.listeners.forEach(({
    ...
    resumePausedMutations() {
      ...
      return this.resuming = (null != (t = this.resuming) ? t : Promise.resolve()).then(() => {
        ...
        return x.batch(() => t.reduce((t, e) => t.then(() => e.continue().catch(i)), Promise.resolve()));
      }).then(() => {
      ...
      onFetch: t => {
        t.fetchFn = () => {
          ...
          const o = null == (e = t.fetchOptions) || null == (s = e.meta) ? void 0 : s.refetchPage,
            u = null == (i = t.fetchOptions) || null == (r = i.meta) ? void 0 : r.fetchMore,
          ...
          let p = f,
            y = !1;
          const v = t.options.queryFn || (() => Promise.reject("Missing queryFn for queryKey '" + t.options.queryHash + "'")),
            m = (t, e, s, i) => (p = i ? [e, ...p] : [...p, e], i ? [s, ...t] : [...t, s]),
            b = (e, s, i, r) => {
              if (y) return Promise.reject("Cancelled");
              if (void 0 === i && !s && e.length) return Promise.resolve(e);
              const n = {
                queryKey: t.queryKey,
                pageParam: i,
                meta: t.options.meta
              ...
              const o = v(n);
              return Promise.resolve(o).then(t => m(e, i, t, r));
            };
          let g;
          if (d.length) {
            if (c) {
              ...
              for (let s = 1; s < d.length; s++) g = g.then(i => {
                if (!o || !d[s] || o(d[s], s, d)) {
                  const r = e ? f[s] : H(t.options, i);
                  return b(i, e, r);
                }
                return Promise.resolve(m(i, f[s], d[s]));
              });
            }
          } else g = b([]);
          return g.then(t => ({
  ...
  class _ extends e {
    ...
    onSubscribe() {
      1 === this.listeners.size && (this.currentQuery.addObserver(this), z(this.currentQuery, this.options) && this.executeFetch(), this.updateTimers());
    }
    onUnsubscribe() {
    ...
    setOptions(t, e) {
      const s = this.options,
        i = this.currentQuery;
      if (this.options = this.client.defaultQueryOptions(t), v(s, this.options) || this.client.getQueryCache().notify({
      ...
      r && J(this.currentQuery, i, this.options, s) && this.executeFetch(), this.updateResult(e), !r || this.currentQuery === i && this.options.enabled === s.enabled && this.options.staleTime === s.staleTime || this.updateStaleTimeout();
      const n = this.computeRefetchInterval();
      !r || this.currentQuery === i && this.options.enabled === s.enabled && n === this.currentRefetchInterval || this.updateRefetchInterval(n);
    }
    getOptimisticResult(t) {
      ...
      return function (t, e, s) {
        ...
        if (!v(t.getCurrentResult(), e)) return !0;
        return !1;
    ...
    executeFetch(t) {
      ...
      return null != t && t.throwOnError || (e = e.catch(i)), e;
    }
    updateStaleTimeout() {
      if (this.clearStaleTimeout(), s || this.currentResult.isStale || !r(this.options.staleTime)) return;
    ...
    updateRefetchInterval(t) {
      this.clearRefetchInterval(), this.currentRefetchInterval = t, !s && !1 !== this.options.enabled && r(this.currentRefetchInterval) && 0 !== this.currentRefetchInterval && (this.refetchIntervalId = setInterval(() => {
        (this.options.refetchIntervalInBackground || P.isFocused()) && this.executeFetch();
    ...
    createResult(t, e) {
      const s = this.currentQuery,
        ...
        h = o ? this.currentResult : this.previousQueryResult,
        {
          state: c
        } = t;
      let l,
      ...
      if (e._optimisticResults) {
        const r = this.hasListeners(),
          n = !r && z(t, e),
          a = r && J(t, s, e, i);
        (n || a) && (y = w(t.options.networkMode) ? "fetching" : "paused", d || (v = "loading")), "isRestoring" === e._optimisticResults && (y = "idle");
      }
      if (e.keepPreviousData && !c.dataUpdatedAt && null != h && h.isSuccess && "error" !== v) l = h.data, d = h.dataUpdatedAt, v = h.status, m = !0;else if (e.select && void 0 !== c.data) {
        if (r && c.data === (null == n ? void 0 : n.data) && e.select === this.selectFn) l = this.selectResult;else try {
          this.selectFn = e.select, l = e.select(c.data), l = C(null == r ? void 0 : r.data, l, e), this.selectResult = l, this.selectError = null;
        } catch (t) {
          this.selectError = t;
        }
      } else l = c.data;
      if (void 0 !== e.placeholderData && void 0 === l && "loading" === v) {
        let t;
        if (null != r && r.isPlaceholderData && e.placeholderData === (null == a ? void 0 : a.placeholderData)) t = r.data;else if (t = "function" == typeof e.placeholderData ? e.placeholderData() : e.placeholderData, e.select && void 0 !== t) try {
          t = e.select(t), this.selectError = null;
        } catch (t) {
          this.selectError = t;
        }
        void 0 !== t && (v = "success", l = C(null == r ? void 0 : r.data, t, e), b = !0);
      }
      ...
      return {
        ...
        isFetching: g,
        isRefetching: g && !O,
        isLoadingError: R && 0 === c.dataUpdatedAt,
        isPaused: "paused" === y,
        isPlaceholderData: b,
        isPreviousData: m,
        isRefetchError: R && 0 !== c.dataUpdatedAt,
        isStale: V(t, e),
    ...
    updateResult(t) {
      ...
      if (this.currentResultState = this.currentQuery.state, this.currentResultOptions = this.options, v(s, e)) return;
    ...
    onQueryUpdate(t) {
      const e = {};
      "success" === t.type ? e.onSuccess = !t.manual : "error" !== t.type || E(t.error) || (e.onError = !0), this.updateResult(e), this.hasListeners() && this.updateTimers();
    }
    notify(t) {
      x.batch(() => {
        var e, s, i, r;
        if (t.onSuccess) null == (e = (s = this.options).onSuccess) || e.call(s, this.currentResult.data), null == (i = (r = this.options).onSettled) || i.call(r, this.currentResult.data, null);else if (t.onError) {
          var n, a, o, u;
  ...
  function J(t, e, s, i) {
    return !1 !== s.enabled && (t !== e || !1 === i.enabled) && (!s.suspense || "error" !== t.state.status) && V(t, s);
  }
  function V(t, e) {
  ...
  t.CancelledError = F, t.InfiniteQueryObserver = class extends _ {
    constructor(t, e) {
      super(t, e);
    }
    bindMethods() {
    ...
    createResult(t, e) {
      ...
      const {
        ...
        h = super.createResult(t, e),
        {
          isFetching: c,
          isRefetching: l
        } = h,
        d = c && "forward" === (null == (s = u.fetchMeta) || null == (i = s.fetchMore) ? void 0 : i.direction),
        f = c && "backward" === (null == (r = u.fetchMeta) || null == (n = r.fetchMore) ? void 0 : n.direction);
      return {
        ...h,
        fetchNextPage: this.fetchNextPage,
        fetchPreviousPage: this.fetchPreviousPage,
        hasNextPage: G(e, null == (a = u.data) ? void 0 : a.pages),
        hasPreviousPage: B(e, null == (o = u.data) ? void 0 : o.pages),
        isFetchingNextPage: d,
        isFetchingPreviousPage: f,
        isRefetching: l && !d && !f
      };
    }
  }, t.MutationCache = k, t.MutationObserver = class extends e {
    constructor(t, e) {
    ...
    notify(t) {
      x.batch(() => {
        var e, s, i, r;
        if (this.mutateOptions && this.hasListeners()) if (t.onSuccess) null == (e = (s = this.mutateOptions).onSuccess) || e.call(s, this.currentResult.data, this.currentResult.variables, this.currentResult.context), null == (i = (r = this.mutateOptions).onSettled) || i.call(r, this.currentResult.data, null, this.currentResult.variables, this.currentResult.context);else if (t.onError) {
          var n, a, o, u;
  ...
  }, t.QueriesObserver = class extends e {
    constructor(t, e) {
    ...
    setQueries(t, e) {
      this.queries = t, x.batch(() => {
        const t = this.observers,
          s = this.findMatchingObservers(this.queries);
        s.forEach(t => t.observer.setOptions(t.defaultedQueryOptions, e));
        const i = s.map(t => t.observer),
          r = Object.fromEntries(i.map(t => [t.options.queryHash, t])),
          a = i.map(t => t.getCurrentResult()),
          o = i.some((e, s) => e !== t[s]);
        (t.length !== i.length || o) && (this.observers = i, this.observersMap = r, this.result = a, this.hasListeners() && (n(t, i).forEach(t => {
          t.destroy();
        }), n(i, t).forEach(t => {
          t.subscribe(e => {
            this.onUpdate(t, e);
    ...
    findMatchingObservers(t) {
      const e = this.observers,
        ...
        i = t.map(t => this.client.defaultQueryOptions(t)),
        r = i.flatMap(t => {
        ...
        n = new Set(r.map(t => t.defaultedQueryOptions.queryHash)),
        a = i.filter(t => !n.has(t.queryHash)),
        o = new Set(r.map(t => t.observer)),
        u = e.filter(t => !o.has(t)),
        h = t => {
          const e = this.client.defaultQueryOptions(t),
            s = this.observersMap[e.queryHash];
          return null != s ? s : new _(this.client, e);
        },
        c = a.map((t, e) => {
      ...
      return r.concat(c).sort((t, e) => i.indexOf(t.defaultedQueryOptions) - i.indexOf(e.defaultedQueryOptions));
    }
    onUpdate(t, e) {
  ...
  }, t.Query = I, t.QueryCache = K, t.QueryClient = class {
    constructor(t = {}) {
      this.queryCache = t.queryCache || new K(), this.mutationCache = t.mutationCache || new k(), this.logger = t.logger || A, this.defaultOptions = t.defaultOptions || {}, this.queryDefaults = [], this.mutationDefaults = [], this.mountCount = 0;
    }
    mount() {
      this.mountCount++, 1 === this.mountCount && (this.unsubscribeFocus = P.subscribe(() => {
        P.isFocused() && (this.resumePausedMutations(), this.queryCache.onFocus());
      }), this.unsubscribeOnline = Q.subscribe(() => {
        Q.isOnline() && (this.resumePausedMutations(), this.queryCache.onOnline());
      }));
    }
    unmount() {
      var t, e;
    ...
    ensureQueryData(t, e, s) {
      const i = o(t, e, s),
        r = this.getQueryData(i.queryKey);
      return r ? Promise.resolve(r) : this.fetchQuery(i);
    }
    getQueriesData(t) {
    ...
    setQueryData(t, e, s) {
      const i = this.queryCache.find(t),
        ...
        }(e, null == i ? void 0 : i.state.data);
      if (void 0 === r) return;
      const n = o(t),
        a = this.defaultQueryOptions(n);
      return this.queryCache.build(this, a).setData(r, {
        ...s,
        manual: !0
      });
    }
    setQueriesData(t, e, s) {
      return x.batch(() => this.getQueryCache().findAll(t).map(({
        queryKey: t
    ...
    resetQueries(t, e, s) {
      ...
      return x.batch(() => (n.findAll(i).forEach(t => {
        t.reset();
      }), this.refetchQueries(a, r)));
    }
    cancelQueries(t, e, s) {
      const [r, n = {}] = u(t, e, s);
      void 0 === n.revert && (n.revert = !0);
      const a = x.batch(() => this.queryCache.findAll(r).map(t => t.cancel(n)));
      return Promise.all(a).then(i).catch(i);
    }
    invalidateQueries(t, e, s) {
      ...
      return x.batch(() => {
        ...
        return this.refetchQueries(s, r);
      });
    }
    refetchQueries(t, e, s) {
      const [r, n] = u(t, e, s),
        a = x.batch(() => this.queryCache.findAll(r).filter(t => !t.isDisabled()).map(t => {
          var e;
          return t.fetch(void 0, {
            ...n,
            cancelRefetch: null == (e = null == n ? void 0 : n.cancelRefetch) || e,
            meta: {
              refetchPage: r.refetchPage
            }
          });
        }));
      let o = Promise.all(a).then(i);
      return null != n && n.throwOnError || (o = o.catch(i)), o;
    }
    fetchQuery(t, e, s) {
      const i = o(t, e, s),
        r = this.defaultQueryOptions(i);
      void 0 === r.retry && (r.retry = !1);
      const n = this.queryCache.build(this, r);
      return n.isStaleByTime(r.staleTime) ? n.fetch(r) : Promise.resolve(n.state.data);
    }
    prefetchQuery(t, e, s) {
      return this.fetchQuery(t, e, s).then(i).catch(i);
    }
    fetchInfiniteQuery(t, e, s) {
      const i = o(t, e, s);
      return i.behavior = j(), this.fetchQuery(i);
    }
    prefetchInfiniteQuery(t, e, s) {
      return this.fetchInfiniteQuery(t, e, s).then(i).catch(i);
    }
    resumePausedMutations() {
    ...
    setQueryDefaults(t, e) {
      const s = this.queryDefaults.find(e => d(t) === d(e.queryKey));
    ...
    getQueryDefaults(t) {
      if (!t) return;
      const e = this.queryDefaults.find(e => f(t, e.queryKey));
      return null == e ? void 0 : e.defaultOptions;
    }
    setMutationDefaults(t, e) {
      const s = this.mutationDefaults.find(e => d(t) === d(e.mutationKey));
    ...
    getMutationDefaults(t) {
      if (!t) return;
      const e = this.mutationDefaults.find(e => f(t, e.mutationKey));
      return null == e ? void 0 : e.defaultOptions;
    }
    defaultQueryOptions(t) {
      ...
      return !e.queryHash && e.queryKey && (e.queryHash = l(e.queryKey, e)), void 0 === e.refetchOnReconnect && (e.refetchOnReconnect = "always" !== e.networkMode), void 0 === e.useErrorBoundary && (e.useErrorBoundary = !!e.suspense), e;
    }
  ...
  }, t.QueryObserver = _, t.defaultShouldDehydrateMutation = X, t.defaultShouldDehydrateQuery = Y, t.dehydrate = function (t, e = {}) {
    const s = [],
      i = [];
    if (!1 !== e.dehydrateMutations) {
      const i = e.shouldDehydrateMutation || X;
      t.getMutationCache().getAll().forEach(t => {
        i(t) && s.push(function (t) {
          return {
    ...
    if (!1 !== e.dehydrateQueries) {
      const s = e.shouldDehydrateQuery || Y;
      t.getQueryCache().getAll().forEach(t => {
        s(t) && i.push(function (t) {
          return {
            state: t.state,
            queryKey: t.queryKey,
  ...
  }, t.focusManager = P, t.hashQueryKey = d, t.hydrate = function (t, e, s) {
    ...
    n.forEach(e => {
      var r;
      i.build(t, {
        ...(null == s || null == (r = s.defaultOptions) ? void 0 : r.mutations),
      ...
      const o = r.get(n);
      if (o) {
        if (o.state.dataUpdatedAt < i.dataUpdatedAt) {
          const {
            fetchStatus: t,
            ...e
          } = i;
        ...
        ...(null == s || null == (a = s.defaultOptions) ? void 0 : a.queries),
        queryKey: e,
        queryHash: n
      }, {
        ...i,
  ...
  }, t.isCancelledError = E, t.isError = function (t) {
    return t instanceof Error;
  }, t.isServer = s, t.matchQuery = h, t.notifyManager = x, t.onlineManager = Q, t.parseFilterArgs = u, t.parseMutationArgs = function (t, e, s) {
    return O(t) ? "function" == typeof e ? {
      ...s,
      mutationKey: t,
      mutationFn: e
  ...
  }, t.parseMutationFilterArgs = function (t, e, s) {
    return O(t) ? [{
      ...e,
      mutationKey: t
    }, s] : [t || {}, e];
  }, t.parseQueryArgs = o, t.replaceEqualDeep = y, Object.defineProperty(t, "__esModule", {
    value: !0
  });
});