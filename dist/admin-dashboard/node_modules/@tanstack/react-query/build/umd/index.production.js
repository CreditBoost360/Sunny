!function (t, e) {
  "object" == typeof exports && "undefined" != typeof module ? e(exports, require("react-dom"), require("react")) : "function" == typeof define && define.amd ? define(["exports", "react-dom", "react"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).ReactQuery = {}, t.ReactDOM, t.React);
}(this, function (t, e, s) {
  "use strict";
  ...
  function C(t) {
    return JSON.stringify(t, (t, e) => E(e) ? Object.keys(e).sort().reduce((t, s) => (t[s] = e[s], t), {}) : e);
  }
  function R(t, e) {
    return S(t, e);
  }
  function S(t, e) {
    return t === e || typeof t == typeof e && !(!t || !e || "object" != typeof t || "object" != typeof e) && !Object.keys(e).some(s => !S(t[s], e[s]));
  }
  function q(t, e) {
    if (t === e) return t;
    const s = Q(t) && Q(e);
  ...
  function D(t, e, s) {
    return null != s.isDataEqual && s.isDataEqual(t, e) ? t : "function" == typeof s.structuralSharing ? s.structuralSharing(t, e) : !1 !== s.structuralSharing ? q(t, e) : e;
  }
  ...
  function j(t) {
    ...
    const u = new Promise((t, e) => {
      ...
      a = () => !A.isFocused() || "always" !== t.networkMode && !I.isOnline(),
      c = r => {
      ...
      d = () => {
        ...
        Promise.resolve(e).then(c).catch(e => {
          ...
          !i && p ? (n++, null == t.onFail || t.onFail(n, e), x(f).then(() => {
            if (a()) return h();
          }).then(() => {
            i ? l(e) : d();
          })) : l(e);
    ...
    return T(t.networkMode) ? d() : h().then(d), {
      promise: u,
      cancel: e => {
        o || (l(new k(e)), null == t.abort || t.abort());
      },
      continue: () => (null == e ? void 0 : e()) ? u : Promise.resolve(),
      cancelRetry: () => {
        i = !0;
      },
      continueRetry: () => {
  ...
  class N {
    ...
    scheduleGc() {
      this.clearGcTimeout(), h(this.cacheTime) && (this.gcTimeout = setTimeout(() => {
        this.optionalRemove();
      }, this.cacheTime));
    }
    updateCacheTime(t) {
      this.cacheTime = Math.max(this.cacheTime || 0, null != t ? t : c ? 1 / 0 : 3e5);
    }
    clearGcTimeout() {
  ...
  class G extends N {
    constructor(t) {
      super(), this.abortSignalConsumed = !1, this.defaultOptions = t.defaultOptions, this.setOptions(t.options), this.observers = [], this.cache = t.cache, this.logger = t.logger || H, this.queryKey = t.queryKey, this.queryHash = t.queryHash, this.initialState = t.state || function (t) {
    ...
    cancel(t) {
      ...
      return null == (e = this.retryer) || e.cancel(t), s ? s.then(l).catch(l) : Promise.resolve();
    }
    destroy() {
    ...
    isStaleByTime(t = 0) {
      return this.state.isInvalidated || !this.state.dataUpdatedAt || !f(this.state.dataUpdatedAt, t);
    }
    onFocus() {
      var t;
    ...
    fetch(t, e) {
      ...
      const l = t => {
        var e, s, r, i;
        (L(t) && t.silent || this.dispatch({
          type: "error",
          error: t
        }), L(t)) || (null == (e = (s = this.cache.config).onError) || e.call(s, t, this), null == (r = (i = this.cache.config).onSettled) || r.call(i, this.state.data, t, this));
      ...
      return this.retryer = j({
        ...
        onSuccess: t => {
          var e, s, r, i;
          void 0 !== t ? (this.setData(t), null == (e = (s = this.cache.config).onSuccess) || e.call(s, t, this), null == (r = (i = this.cache.config).onSettled) || r.call(i, t, this.state.error, this), this.isFetchingOptimistic || this.scheduleGc(), this.isFetchingOptimistic = !1) : l(new Error(this.queryHash + " data is undefined"));
        },
        onError: l,
        onFail: (t, e) => {
          this.dispatch({
  ...
  class _ extends a {
    ...
    find(t, e) {
      const [s] = v(t, e);
      return void 0 === s.exact && (s.exact = !0), this.queries.find(t => b(s, t));
    }
    findAll(t, e) {
      const [s] = v(t, e);
      return Object.keys(s).length > 0 ? this.queries.filter(t => b(s, t)) : this.queries;
    }
    notify(t) {
      B.batch(() => {
        this.listeners.forEach(({
  ...
  class z extends N {
    constructor(t) {
      super(), this.defaultOptions = t.defaultOptions, this.mutationId = t.mutationId, this.mutationCache = t.mutationCache, this.logger = t.logger || H, this.observers = [], this.state = t.state || W(), this.setOptions(t.options), this.scheduleGc();
    }
    setOptions(t) {
      this.options = {
        ...this.defaultOptions,
  ...
  class J extends a {
    ...
    find(t) {
      return void 0 === t.exact && (t.exact = !0), this.mutations.find(e => g(t, e));
    }
    findAll(t) {
    ...
    resumePausedMutations() {
      ...
      return this.resuming = (null != (t = this.resuming) ? t : Promise.resolve()).then(() => {
        ...
        return B.batch(() => t.reduce((t, e) => t.then(() => e.continue().catch(l)), Promise.resolve()));
      }).then(() => {
        ...
        t.fetchFn = () => {
          ...
          if (d.length) {
            if (l) {
              ...
              g = !u || !d[0] || u(d[0], 0, d) ? b([], e, f[0]) : Promise.resolve(m([], f[0], d[0]));
  ...
  class tt extends a {
    ...
    onSubscribe() {
      1 === this.listeners.size && (this.currentQuery.addObserver(this), et(this.currentQuery, this.options) && this.executeFetch(), this.updateTimers());
    }
    onUnsubscribe() {
      this.hasListeners() || this.destroy();
    }
    shouldFetchOnReconnect() {
      return st(this.currentQuery, this.options, this.options.refetchOnReconnect);
    }
    shouldFetchOnWindowFocus() {
      return st(this.currentQuery, this.options, this.options.refetchOnWindowFocus);
    }
    destroy() {
    ...
    setOptions(t, e) {
      const s = this.options,
        r = this.currentQuery;
      if (this.options = this.client.defaultQueryOptions(t), P(s, this.options) || this.client.getQueryCache().notify({
      ...
      i && rt(this.currentQuery, r, this.options, s) && this.executeFetch(), this.updateResult(e), !i || this.currentQuery === r && this.options.enabled === s.enabled && this.options.staleTime === s.staleTime || this.updateStaleTimeout();
    ...
    updateStaleTimeout() {
      if (this.clearStaleTimeout(), c || this.currentResult.isStale || !h(this.options.staleTime)) return;
      const t = f(this.currentResult.dataUpdatedAt, this.options.staleTime) + 1;
    ...
    updateRefetchInterval(t) {
      this.clearRefetchInterval(), this.currentRefetchInterval = t, !c && !1 !== this.options.enabled && h(this.currentRefetchInterval) && 0 !== this.currentRefetchInterval && (this.refetchIntervalId = setInterval(() => {
        (this.options.refetchIntervalInBackground || A.isFocused()) && this.executeFetch();
    ...
    createResult(t, e) {
      ...
      if (e._optimisticResults) {
        const i = this.hasListeners(),
          n = !i && et(t, e),
          o = i && rt(t, s, e, r);
        (n || o) && (y = T(t.options.networkMode) ? "fetching" : "paused", d || (v = "loading")), "isRestoring" === e._optimisticResults && (y = "idle");
      }
      if (e.keepPreviousData && !l.dataUpdatedAt && null != c && c.isSuccess && "error" !== v) h = c.data, d = c.dataUpdatedAt, v = c.status, m = !0;else if (e.select && void 0 !== l.data) {
        if (i && l.data === (null == n ? void 0 : n.data) && e.select === this.selectFn) h = this.selectResult;else try {
          this.selectFn = e.select, h = e.select(l.data), h = D(null == i ? void 0 : i.data, h, e), this.selectResult = h, this.selectError = null;
        } catch (t) {
          this.selectError = t;
        }
      } else h = l.data;
      if (void 0 !== e.placeholderData && void 0 === h && "loading" === v) {
        ...
        void 0 !== t && (v = "success", h = D(null == i ? void 0 : i.data, t, e), b = !0);
      }
    ...
    updateResult(t) {
      ...
      if (this.currentResultState = this.currentQuery.state, this.currentResultOptions = this.options, P(s, e)) return;
    ...
    onQueryUpdate(t) {
      const e = {};
      "success" === t.type ? e.onSuccess = !t.manual : "error" !== t.type || L(t.error) || (e.onError = !0), this.updateResult(e), this.hasListeners() && this.updateTimers();
    }
    notify(t) {
      B.batch(() => {
        var e, s, r, i;
  ...
  function et(t, e) {
    ...
    }(t, e) || t.state.dataUpdatedAt > 0 && st(t, e, e.refetchOnMount);
  }
  function st(t, e, s) {
    if (!1 !== e.enabled) {
  ...
  function rt(t, e, s, r) {
    return !1 !== s.enabled && (t !== e || !1 === r.enabled) && (!s.suspense || "error" !== t.state.status) && it(t, s);
  }
  function it(t, e) {
  ...
  class nt extends a {
    ...
    setQueries(t, e) {
      this.queries = t, B.batch(() => {
        ...
        const r = s.map(t => t.observer),
          ...
          o = r.some((e, s) => e !== t[s]);
        (t.length !== r.length || o) && (this.observers = r, this.observersMap = i, this.result = n, this.hasListeners() && (d(t, r).forEach(t => {
          t.destroy();
        }), d(r, t).forEach(t => {
          t.subscribe(e => {
            this.onUpdate(t, e);
    ...
    findMatchingObservers(t) {
      ...
      return i.concat(l).sort((t, e) => r.indexOf(t.defaultedQueryOptions) - r.indexOf(e.defaultedQueryOptions));
    }
    onUpdate(t, e) {
  ...
  class ot extends tt {
    ...
    createResult(t, e) {
      ...
      const {
        ...
        d = l && "forward" === (null == (s = a.fetchMeta) || null == (r = s.fetchMore) ? void 0 : r.direction),
        f = l && "backward" === (null == (i = a.fetchMeta) || null == (n = i.fetchMore) ? void 0 : n.direction);
      return {
        ...c,
  ...
  class ut extends a {
    ...
    setOptions(t) {
      var e;
      const s = this.options;
      this.options = this.client.defaultMutationOptions(t), P(s, this.options) || this.client.getMutationCache().notify({
        type: "observerOptionsUpdated",
    ...
    notify(t) {
      B.batch(() => {
        var e, s, r, i;
        if (this.mutateOptions && this.hasListeners()) if (t.onSuccess) null == (e = (s = this.mutateOptions).onSuccess) || e.call(s, this.currentResult.data, this.currentResult.variables, this.currentResult.context), null == (r = (i = this.mutateOptions).onSettled) || r.call(i, this.currentResult.data, null, this.currentResult.variables, this.currentResult.context);else if (t.onError) {
          var n, o, u, a;
  ...
  function lt(t, e, s) {
    ...
    n.forEach(e => {
      ...
      if (u) {
        ...
        ...(null == s || null == (o = s.defaultOptions) ? void 0 : o.queries),
        queryKey: e,
        queryHash: n
      }, {
        ...r,
  ...
  !function (t) {
    t.exports = function () {
      ...
      dt = 1;
      var t = o.default,
        e = "function" == typeof Object.is ? Object.is : function (t, e) {
      ...
      var a = "undefined" == typeof window || void 0 === window.document || void 0 === window.document.createElement ? function (t, e) {
        ...
        var o = e(),
          ...
          l = a[1];
        return i(function () {
          c.value = o, c.getSnapshot = e, u(c) && l({
            inst: c
          });
        }, [t, o, e]), r(function () {
          return u(c) && l({
      ...
      return pt.useSyncExternalStore = void 0 !== t.useSyncExternalStore ? t.useSyncExternalStore : a, pt;
    }();
  }(ft);
  ...
  function bt(t, e) {
    return t || (e && "undefined" != typeof window ? (window.ReactQueryClientContext || (window.ReactQueryClientContext = vt), window.ReactQueryClientContext) : vt);
  }
  const gt = ({
      context: t
    } = {}) => {
  ...
  const Et = (t, e) => {
    ...
    At = (t, e, s) => e.fetchOptimistic(t).then(({
      data: e
    }) => {
  ...
  function Ut(t, e) {
    ...
    n._optimisticResults = r ? "isRestoring" : "optimistic", n.onError && (n.onError = B.batchCalls(n.onError)), n.onSuccess && (n.onSuccess = B.batchCalls(n.onSuccess)), n.onSettled && (n.onSettled = B.batchCalls(n.onSettled)), xt(n), Et(n, i), wt(i);
    const [o] = u.useState(() => new e(s, n)),
      a = o.getOptimisticResult(n);
    if (yt(u.useCallback(t => {
      const e = r ? () => {} : o.subscribe(B.batchCalls(t));
      return o.updateResult(), e;
    }, [o, r]), () => o.getCurrentResult(), () => o.getCurrentResult()), u.useEffect(() => {
      o.setOptions(n, {
        listeners: !1
      });
    }, [n, o]), Dt(n, a, r)) throw At(n, o, i);
    if (Mt({
      result: a,
  ...
  function It(t, e = {}) {
    const s = gt({
      ...
      r = u.useRef(e);
    r.current = e, u.useMemo(() => {
      t && lt(s, t, r.current);
    }, [s, t]);
  }
  function Kt() {}
  t.CancelledError = k, t.Hydrate = ({
    children: t,
    options: e,
    state: s
  }) => (It(s, e), t), t.InfiniteQueryObserver = ot, t.IsRestoringProvider = Rt, t.MutationCache = J, t.MutationObserver = ut, t.QueriesObserver = nt, t.Query = G, t.QueryCache = _, t.QueryClient = class {
    constructor(t = {}) {
      this.queryCache = t.queryCache || new _(), this.mutationCache = t.mutationCache || new J(), this.logger = t.logger || H, this.defaultOptions = t.defaultOptions || {}, this.queryDefaults = [], this.mutationDefaults = [], this.mountCount = 0;
    }
    mount() {
      this.mountCount++, 1 === this.mountCount && (this.unsubscribeFocus = A.subscribe(() => {
        A.isFocused() && (this.resumePausedMutations(), this.queryCache.onFocus());
    ...
    setQueriesData(t, e, s) {
      return B.batch(() => this.getQueryCache().findAll(t).map(({
        queryKey: t
    ...
    resetQueries(t, e, s) {
      ...
      return B.batch(() => (n.findAll(r).forEach(t => {
        t.reset();
    ...
    cancelQueries(t, e, s) {
      ...
      const n = B.batch(() => this.queryCache.findAll(r).map(t => t.cancel(i)));
    ...
    refetchQueries(t, e, s) {
      const [r, i] = v(t, e, s),
        n = B.batch(() => this.queryCache.findAll(r).filter(t => !t.isDisabled()).map(t => {
          var e;
    ...
    setQueryDefaults(t, e) {
      const s = this.queryDefaults.find(e => C(t) === C(e.queryKey));
    ...
    setMutationDefaults(t, e) {
      const s = this.mutationDefaults.find(e => C(t) === C(e.mutationKey));
    ...
    getMutationDefaults(t) {
      if (!t) return;
      const e = this.mutationDefaults.find(e => R(t, e.mutationKey));
      return null == e ? void 0 : e.defaultOptions;
    }
    defaultQueryOptions(t) {
      ...
      return !e.queryHash && e.queryKey && (e.queryHash = O(e.queryKey, e)), void 0 === e.refetchOnReconnect && (e.refetchOnReconnect = "always" !== e.networkMode), void 0 === e.useErrorBoundary && (e.useErrorBoundary = !!e.suspense), e;
    }
    ...
    const i = bt(s, r);
    return u.createElement(mt.Provider, {
      value: !s && r
  ...
  }, t.QueryObserver = tt, t.defaultContext = vt, t.defaultShouldDehydrateMutation = at, t.defaultShouldDehydrateQuery = ct, t.dehydrate = function (t, e = {}) {
    const s = [],
      r = [];
  ...
  }, t.focusManager = A, t.hashQueryKey = C, t.hydrate = lt, t.isCancelledError = L, t.isError = function (t) {
    return t instanceof Error;
  }, t.isServer = c, t.matchQuery = b, t.notifyManager = B, t.onlineManager = I, t.parseFilterArgs = v, t.parseMutationArgs = y, t.parseMutationFilterArgs = m, t.parseQueryArgs = p, t.replaceEqualDeep = q, t.useHydrate = It, t.useInfiniteQuery = function (t, e, s) {
    ...
    const [r, i = {}] = v(t, e, s),
      ...
      o = n.getQueryCache();
    return yt(u.useCallback(t => o.subscribe(B.batchCalls(t)), [o]), () => n.isFetching(r), () => n.isFetching(r));
    ...
    return yt(u.useCallback(t => o.subscribe(B.batchCalls(t)), [o]), () => n.isMutating(r), () => n.isMutating(r));
  }, t.useIsRestoring = Ct, t.useMutation = function (t, e, s) {
    const r = y(t, e, s),
      i = gt({
        context: r.context
      }),
    ...
    const o = yt(u.useCallback(t => n.subscribe(B.batchCalls(t)), [n]), () => n.getCurrentResult(), () => n.getCurrentResult()),
      a = u.useCallback((t, e) => {
        n.mutate(t, e).catch(Kt);
      }, [n]);
    if (o.error && Qt(n.options.useErrorBoundary, [o.error])) throw o.error;
    return {
      ...o,
      mutate: a,
    ...
    const [o] = u.useState(() => new nt(s, n)),
      a = o.getOptimisticResult(n);
    yt(u.useCallback(t => r ? () => {} : o.subscribe(B.batchCalls(t)), [o, r]), () => o.getCurrentResult(), () => o.getCurrentResult()), u.useEffect(() => {
      o.setQueries(n, {
        listeners: !1
      });
    }, [n, o]);
    const c = a.some((t, e) => Dt(n[e], t, r)) ? a.flatMap((t, e) => {
      const s = n[e],
        u = o.getObservers()[e];
      if (s && u) {
    ...
    const l = o.getQueries(),
      h = a.find((t, e) => {
        ...
        return Mt({
          result: t,
          errorResetBoundary: i,
          useErrorBoundary: null != (s = null == (r = n[e]) ? void 0 : r.useErrorBoundary) && s,
          query: l[e]
        });
      });
  ...
  }, t.useQueryClient = gt, t.useQueryErrorResetBoundary = Pt, Object.defineProperty(t, "__esModule", {
    value: !0
  });
});