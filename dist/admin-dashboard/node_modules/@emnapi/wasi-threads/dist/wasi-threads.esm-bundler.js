...
function getPostMessage(options) {
  return typeof (options === null || options === void 0 ? void 0 : options.postMessage) === 'function' ? options.postMessage : typeof postMessage === 'function' ? postMessage : undefined;
}
...
function createInstanceProxy(instance, memory) {
  ...
  var createHandler = function (target) {
    var handlers = ['apply', 'construct', 'defineProperty', 'deleteProperty', 'get', 'getOwnPropertyDescriptor', 'getPrototypeOf', 'has', 'isExtensible', 'ownKeys', 'preventExtensions', 'set', 'setPrototypeOf'];
    var handler = {};
    var _loop_1 = function (i) {
...
function getWasiSymbol(wasi, description) {
  ...
  var selectDescription = function (description) {
    return function (s) {
      if (s.description) {
...
var ThreadMessageHandler = /*#__PURE__*/function () {
  ...
  ThreadMessageHandler.prototype._load = function (payload) {
    ...
    if (typeof then === 'function') {
      // eslint-disable-next-line @typescript-eslint/no-floating-promises
      then.call(source, function (source) {
        _this._loaded(null, source, payload);
      }, function (err) {
  ...
  ThreadMessageHandler.prototype._start = function (payload) {
    ...
    postMessage(createMessage('cleanup-thread', {
      tid: tid
    }));
  };
