...
function validateOptions(options) {
  ...
  //   }
  // }
  if (options.print !== undefined) (0, util_1.validateFunction)(options.print, 'options.print');
  if (options.printErr !== undefined) (0, util_1.validateFunction)(options.printErr, 'options.printErr');
