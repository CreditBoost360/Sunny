!function (t, e) {
  "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).FloatingUIUtils = {});
}(this, function (t) {
  "use strict";

  const e = ["top", "right", "bottom", "left"],
    n = ["start", "end"],
    o = e.reduce((t, e) => t.concat(e, e + "-" + n[0], e + "-" + n[1]), []),
    i = Math.min,
    r = Math.max,
    c = Math.round,
    u = Math.floor,
  ...
  t.alignments = n, t.clamp = function (t, e, n) {
    ...
    return i && (r = r.map(t => t + "-" + i), e && (r = r.concat(r.map(h)))), r;
