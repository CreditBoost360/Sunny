!function (t, e) {
  ...
  async function A(t, e) {
    ...
    const {
      ...
      b = await (null == r.getOffsetParent ? void 0 : r.getOffsetParent(l.floating)),
      A = (await (null == r.isElement ? void 0 : r.isElement(b))) && (await (null == r.getScale ? void 0 : r.getScale(b))) || {
        x: 1,
        y: 1
      },
        ...
        if (S = [...S, {
          ...
          if (!n) switch (v) {
            case "bestFit":
              {
                var M;
                const t = null == (M = S.filter(t => {
                  if (k) {
                    const e = g(t.placement);
                    return e === T || "y" === e;
                  }
                  return !0;
                }).map(t => [t.placement, t.overflows.filter(t => t > 0).reduce((t, e) => t + e, 0)]).sort((t, e) => t[1] - e[1])[0]) ? void 0 : M[0];
                t && (n = t);
                break;
              }
    ...
    return void 0 === t && (t = {}), {
      ...
      async fn(e) {
        const {
          ...
          p = Array.from((await (null == l.getClientRects ? void 0 : l.getClientRects(i.reference))) || []),
          h = function (t) {
