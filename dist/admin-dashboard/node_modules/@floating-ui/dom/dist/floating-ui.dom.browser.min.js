import { rectToClientRect as t, arrow as e, autoPlacement as n, detectOverflow as o, flip as i, hide as r, inline as c, limitShift as l, offset as s, shift as u, size as f, computePosition as a } from "@floating-ui/core";
const d = Math.min,
  h = Math.max,
  p = Math.round,
  g = Math.floor,
...
function Y(t, e, n) {
  ...
  return {
    x: o.left + e.scrollLeft - (n ? 0 : X(t, o)),
    y: o.top + e.scrollTop
  };
}
function $(e, n, o) {
  let i;
  if ("viewport" === n) i = function (t, e) {
    const n = x(t),
      o = v(t),
      i = n.visualViewport;
    let r = o.clientWidth,
  ...
  }(e, o);else if ("document" === n) i = function (t) {
    const e = v(t),
      n = W(t),
    ...
    const l = -n.scrollTop;
    return "rtl" === H(o).direction && (c += h(e.clientWidth, o.clientWidth) - i), {
      width: i,
      height: r,
      x: c,
      y: l
    };
  }(v(e));else if (L(n)) i = function (t, e) {
...
function j(t, e, n) {
  ...
  if (o || !o && !r) if (("body" !== w(e) || E(i)) && (l = W(e)), o) {
    const t = q(e, !0, r, e);
    s.x = t.x + e.clientLeft, s.y = t.y + e.clientTop;
  } else i && u();
  r && !o && i && u();
  const f = !i || o || r ? m(0) : Y(i, l);
  return {
...
function K(t, e) {
  ...
  return o && O(o) && G(o) && !F(o) ? n : o || function (t) {
    let e = M(t);
    for (; T(e) && !O(e);) {
      if (F(e)) return e;
      if (S(e)) return null;
...
const Q = {
  ...
  getClippingRect: function (t) {
    ...
    const r = [...("clippingAncestors" === n ? S(e) ? [] : function (t, e) {
        const n = e.get(t);
        if (n) return n;
        ...
        for (; L(c) && !O(c);) {
          const e = H(c),
            n = F(c);
          n || "fixed" !== e.position || (i = null), (r ? !n && !i : !n && "static" === e.position && i && ["absolute", "fixed"].includes(i.position) || E(c) && !n && _(t, c)) ? o = o.filter(t => t !== c) : i = e, c = M(c);
        }
        return e.set(t, o), o;
  ...
  getElementRects: async function (t) {
    ...
    return {
      reference: j(t.reference, await e(t.floating), t.strategy),
      floating: {
        x: 0,
        y: 0,
        width: o.width,
...
function Z(t, e, n, o) {
  ...
  c && (y = new ResizeObserver(t => {
    let [o] = t;
    o && o.target === u && y && (y.unobserve(e), cancelAnimationFrame(m), m = requestAnimationFrame(() => {
      var t;
      null == (t = y) || t.observe(e);
    })), n();
  }), u && !s && y.observe(u), y.observe(e));
  let w = s ? q(t) : null;
  return s && function e() {
    const o = q(t);
    w && !U(w, o) && n();
    ...
    }), null == a || a(), null == (t = y) || t.disconnect(), y = null, s && cancelAnimationFrame(p);
  };
}
const tt = o,
  et = s,
...
export { lt as arrow, nt as autoPlacement, Z as autoUpdate, ft as computePosition, tt as detectOverflow, it as flip, z as getOverflowAncestors, ct as hide, st as inline, ut as limitShift, et as offset, Q as platform, ot as shift, rt as size };