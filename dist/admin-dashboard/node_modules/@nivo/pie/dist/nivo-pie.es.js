import { useMemo as e, useState as i, useCallback as n, createElement as t, Fragment as r, useRef as a, useEffect as o } from "react";
...
function F(e, i) {
  ...
  var n,
    ...
    r = {},
    a = Object.keys(e);
  for (t = 0; t < a.length; t++) n = a[t], i.indexOf(n) >= 0 || (r[n] = e[n]);
  return r;
}
var H,
  X = function (e) {
    ...
    var n = i.data,
      ...
      L = e(function () {
        var e = T().value(function (e) {
          return e.value;
        }).startAngle(s(t)).endAngle(s(r)).padAngle(s(d));
    ...
    var r = t.data,
      ...
      B = e(function () {
        ...
        if (O) {
          ...
          g.x = (a - g.width) / 2, g.y = (o - g.height) / 2, t = (t - c.x) / c.width * c.width * v + g.x, r = (r - c.y) / c.height * c.height * v + g.y, e = {
            box: c,
            ratio: v,
            points: s
          }, i *= v, n *= v;
  ...
  U = function (e) {
    var i = e.data,
      ...
      te = void 0 === ne ? Y.arcLabelsTextColor : ne,
    ...
    L.includes("arcs") && (ci.arcs = W(N, {
      ...
      tooltip: He,
      transitionMode: Ye
    }, "arcs")), le && L.includes("arcLinkLabels") && (ci.arcLinkLabels = W(R, {
      center: [ti, ri],
      data: ei,
      label: ce,
      skipAngle: ve,
      ...
      linkColor: xe,
      component: Me
    }, "arcLinkLabels")), Z && L.includes("arcLabels") && (ci.arcLabels = W(m, {
      center: [ti, ri],
      data: ei,
      label: _,
      radiusOffset: ae,
  ...
  Z = function (e) {
    var i = e.isInteractive,
      n = void 0 === i ? Y.isInteractive : i,
      t = e.animate,
      r = void 0 === t ? Y.animate : t,
      a = e.motionConfig,
  ...
  ee = function (i) {
    var n = i.data,
      ...
      ne = i.enableArcLabels,
      te = void 0 === ne ? Y.enableArcLabels : ne,
      re = i.arcLabel,
    ...
    o(function () {
      if (Xe.current) {
        ...
        e.scale(Q, Q), e.fillStyle = Ye.background, e.fillRect(0, 0, Je, Ke), e.save(), e.translate(Pe.left, Pe.top), Ze.context(e), e.save(), e.translate($e, _e), Ue.forEach(function (i) {
          e.beginPath(), e.fillStyle = i.color, e.strokeStyle = ti(i), e.lineWidth = _, Ze(i.arc), e.fill(), _ > 0 && e.stroke();
        }), !0 === fe && I(e, ai, Ye, Ie), !0 === te && x(e, ri, Ye), e.restore(), He.forEach(function (i) {
          w(e, D({}, i, {
            data: Ue,
            containerWidth: qe,
            containerHeight: ze,
    ...
    }, [Xe, qe, ze, Je, Ke, Pe.top, Pe.left, Q, $e, _e, Ze, Ue, ti, te, ri, fe, ai, Ie, He, Ye]);
    var oi = e(function () {
      ...
      di = function (e) {
        ...
        var i = b(Xe.current, e),
          n = i[0],
          t = i[1],
          r = M(Pe.left + $e, Pe.top + _e, ei, ii, oi, n, t);
      ...
      ui = function (e) {
        var i = di(e);
        i ? (null == Ge || Ge(i, e), ni(i.id), si(t(De, {
          datum: i
        }), e)) : (ni(null), ci());
      };
    return W("canvas", {
...
export { Z as Pie, ie as PieCanvas, $ as ResponsivePie, ne as ResponsivePieCanvas, Y as defaultProps, P as useNormalizedData, z as usePie, q as usePieArcs, J as usePieFromBox, K as usePieLayerContext };