...
var RemoteHttpInterceptor = /** @class */function (_super) {
  ...
  function RemoteHttpInterceptor() {
    return _super.call(this, {
      ...
      interceptors: [new ClientRequest_1.ClientRequestInterceptor(), new XMLHttpRequest_1.XMLHttpRequestInterceptor()]
    }) || this;
  }
...
var RemoteHttpResolver = /** @class */function (_super) {
  ...
  RemoteHttpResolver.prototype.setup = function () {
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              isomorphicRequest = new IsomorphicRequest_1.IsomorphicRequest(requestJson.url, __assign(__assign({}, requestJson), {
                body: body.buffer
              }));
    ...
    this.process.once('error', function () {
