...
let modules = await glob("*.js", {
  cwd: root("esm")
});
const task_queue = [];
const NO_MODIFY = ["/* This file is automatically generated and should not be manually edited. */", "/* To modify this file, please run the `npm run build` command instead. */"];
...
modules.forEach(p => {
  ...
  task_queue.push(fs.outputJSON(root("_", importBinding, "package.json"), alias_package, {
    encoding: "utf-8",
    spaces: 4
  }));
  ...
  task_queue.push(fs.outputFile(root("src", `${importBinding}.mjs`), re_export_esm(importBinding), {
    encoding: "utf-8"
  }));
...
indexCJS.push(`0 && (module.exports = {`, "/* @Annotate_start: the CommonJS named exports for ESM import in node */", ...cjs_module_lexer, "/* @Annotate_end */", `});`, `module.exports = {`, ...cjs_export_list, `};`);
task_queue.push(fs.outputJSON(root("package.json"), main_package_json, {
  spaces: 4
