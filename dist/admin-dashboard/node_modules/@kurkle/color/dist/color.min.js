 ...
 */
!function (e, t) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self)["@kurkle/color"] = t();
}(this, function () {
  "use strict";
  ...
  function m(e) {
    const t = e.r / 255,
      ...
      i = (n + a) / 2;
    let s, c, b;
    return n !== a && (b = n - a, c = i > .5 ? b / (2 - n - a) : b / (n + a), s = function (e, t, f, r, n) {
      return e === n ? (t - f) / r + (t < f ? 6 : 0) : t === n ? (f - e) / r + 2 : (e - t) / r + 4;
    }(t, f, r, b, n), s = 60 * s + .5), [0 | s, c || 0, i];
  }
  function y(e, t, f, n) {
  ...
  function _(e) {
    ...
    const i = w(+t[2]),
      s = +t[3] / 100,
      c = +t[4] / 100;
    return n = "hwb" === t[1] ? v(i, s, c) : "hsv" === t[1] ? x(i, s, c) : Y(i, s, c), {
      r: n[0],
      g: n[1],
      b: n[2],
      a: a
  ...
  function P(e) {
    ...
    if (r) {
      ...
      return n = +r[1], a = +r[3], i = +r[5], n = 255 & (r[2] ? f(n) : t(n, 0, 255)), a = 255 & (r[4] ? f(a) : t(a, 0, 255)), i = 255 & (r[6] ? f(i) : t(i, 0, 255)), {
        r: n,
        g: a,
        b: i,
        a: s
  ...
  const $ = e => e <= .0031308 ? 12.92 * e : 1.055 * Math.pow(e, 1 / 2.4) - .055,
    E = e => e <= .04045 ? e / 12.92 : Math.pow((e + .055) / 1.055, 2.4);
  function R(e, t, f) {
    if (e) {
      let r = m(e);
  ...
  class V {
    ...
    mix(e, t) {
      if (e) {
        ...
        n = 1 - c, f.r = 255 & c * f.r + n * r.r + .5, f.g = 255 & c * f.g + n * r.g + .5, f.b = 255 & c * f.b + n * r.b + .5, f.a = a * f.a + (1 - a) * r.a, this.rgb = f;
      }
      return this;
    }
    interpolate(e, t) {
      return e && (this._rgb = function (e, t, f) {
        const a = E(n(e.r)),
          i = E(n(e.g)),
          s = E(n(e.b));
        return {
