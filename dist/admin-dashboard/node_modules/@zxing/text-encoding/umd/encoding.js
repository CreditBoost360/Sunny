(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = global || self, factory(global.TextEncoding = {}));
  ...
  function decoderError(fatal, opt_code_point) {
    if (opt_code_point === void 0) {
      opt_code_point = undefined;
    }
  ...
  function checkForEncodingIndexes() {
    if (typeof TextEncodingIndexes !== 'undefined') return TextEncodingIndexes.encodingIndexes;
    var glo = getGlobalScope();
    if (!glo) return null;
    if ('TextEncodingIndexes' in glo) return global['TextEncodingIndexes']['encodingIndexes'];
    if ('encoding-indexes' in glo) return global['encodingIndexes'];
    return null;
  }
  ...
  var EUCJPDecoder = /** @class */function () {
    function EUCJPDecoder(options) {
      ...
      /** @type {boolean} */
      this.eucjp_jis0212_flag = false, /** @type {number} */this.eucjp_lead = 0x00;
    }
    /**
     * @param {Stream} stream The stream of bytes being decoded.
     * @param {number} bite The next byte read from the stream.
  ...
  var GB18030Decoder = /** @class */function () {
    function GB18030Decoder(options) {
      ...
      /** @type {number} */
      this.gb18030_first = 0x00, /** @type {number} */this.gb18030_second = 0x00, /** @type {number} */this.gb18030_third = 0x00;
    }
    /**
     * @param {Stream} stream The stream of bytes being decoded.
     * @param {number} bite The next byte read from the stream.
  ...
  var ISO2022JPDecoder = /** @class */function () {
    ...
    function ISO2022JPDecoder(options) {
      ...
      /** @type {number} */
      this.iso2022jp_decoder_state = states.ASCII, /** @type {number} */this.iso2022jp_decoder_output_state = states.ASCII, /** @type {number} */this.iso2022jp_lead = 0x00, /** @type {boolean} */this.iso2022jp_output_flag = false;
    }
    /**
     * @param {Stream} stream The stream of bytes being decoded.
     * @param {number} bite The next byte read from the stream.
  ...
  var ISO2022JPEncoder = /** @class */function () {
    ...
    ISO2022JPEncoder.prototype.handler = function (stream, code_point) {
      ...
      if (code_point === end_of_stream && this.iso2022jp_state === states$1.ASCII) return finished;
      // 3. If ISO-2022-JP encoder state is ASCII or Roman, and code
      // point is U+000E, U+000F, or U+001B, return error with U+FFFD.
      if ((this.iso2022jp_state === states$1.ASCII || this.iso2022jp_state === states$1.Roman) && (code_point === 0x000E || code_point === 0x000F || code_point === 0x001B)) {
        return encoderError(0xFFFD);
      }
      // 4. If iso-2022-jp encoder state is ASCII and code point is an
      // ASCII code point, return a byte whose value is code point.
      if (this.iso2022jp_state === states$1.ASCII && isASCIICodePoint(code_point)) return code_point;
      // 5. If iso-2022-jp encoder state is Roman and code point is an
      // ASCII code point, excluding U+005C and U+007E, or is U+00A5
      // or U+203E, run these substeps:
      if (this.iso2022jp_state === states$1.Roman && (isASCIICodePoint(code_point) && code_point !== 0x005C && code_point !== 0x007E || code_point == 0x00A5 || code_point == 0x203E)) {
      ...
      // iso-2022-jp encoder state to ASCII, and return three bytes
      // 0x1B 0x28 0x42.
      if (isASCIICodePoint(code_point) && this.iso2022jp_state !== states$1.ASCII) {
        stream.prepend(code_point);
        this.iso2022jp_state = states$1.ASCII;
        return [0x1B, 0x28, 0x42];
      }
      ...
      // 0x1B 0x28 0x4A.
      if ((code_point === 0x00A5 || code_point === 0x203E) && this.iso2022jp_state !== states$1.Roman) {
        stream.prepend(code_point);
  ...
  var UTF8Decoder = /** @class */function () {
    function UTF8Decoder(options) {
      ...
      // (initially 0xBF).
      /** @type {number} */
      this.utf8_code_point = 0, /** @type {number} */this.utf8_bytes_seen = 0, /** @type {number} */this.utf8_bytes_needed = 0, /** @type {number} */this.utf8_lower_boundary = 0x80, /** @type {number} */this.utf8_upper_boundary = 0xBF;
    }
    /**
     * @param {Stream} stream The stream of bytes being decoded.
     * @param {number} bite The next byte read from the stream.
  ...
  var encoders = {
    ...
    /** @param {{fatal: boolean}} options */
    'x-user-defined': function (options) {
  ...
  if (typeof window !== 'undefined') {
    var checkUndefined = function (key) {
      return !(key in window) || typeof window[key] === 'undefined' || window[key] === null;
    };
