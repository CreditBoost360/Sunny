...
var ISO2022JPEncoder = /** @class */function () {
  ...
  ISO2022JPEncoder.prototype.handler = function (stream, code_point) {
    ...
    if (code_point === end_of_stream && this.iso2022jp_state === states.ASCII) return finished;
    ...
    if (this.iso2022jp_state === states.ASCII && isASCIICodePoint(code_point)) return code_point;
    // 5. If iso-2022-jp encoder state is Roman and code point is an
    // ASCII code point, excluding U+005C and U+007E, or is U+00A5
    // or U+203E, run these substeps:
    if (this.iso2022jp_state === states.Roman && (isASCIICodePoint(code_point) && code_point !== 0x005C && code_point !== 0x007E || code_point == 0x00A5 || code_point == 0x203E)) {
