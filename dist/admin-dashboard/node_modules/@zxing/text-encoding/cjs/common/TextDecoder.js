...
var TextDecoder = /** @class */function () {
  ...
  TextDecoder.prototype.decode = function (input, options) {
    ...
    while (true) {
      ...
      if (token === terminology_1.end_of_stream) break;
      // 3. Otherwise, run these subsubsteps:
      // 1. Let result be the result of processing token for decoder,
      // stream, output, and error mode.
      result = this._decoder.handler(input_stream, token);
      // 2. If result is finished, return output, serialized.
      if (result === finished_1.finished) break;
      if (result !== null) {
  ...
  TextDecoder.prototype.serializeStream = function (stream) {
    ...
    if (utilities_1.includes(['UTF-8', 'UTF-16LE', 'UTF-16BE'], this._encoding.name) && !this._ignoreBOM && !this._BOMseen) {
