  ...
  ISO2022JPDecoder.prototype.handler = function (stream, bite) {
    ...
    switch (this.iso2022jp_decoder_state) {
      ...
      case states.ASCII:
        ...
        if (utilities_1.inRange(bite, 0x00, 0x7F) && bite !== 0x0E && bite !== 0x0F && bite !== 0x1B) {
      ...
      case states.Roman:
        ...
        if (utilities_1.inRange(bite, 0x00, 0x7F) && bite !== 0x0E && bite !== 0x0F && bite !== 0x1B && bite !== 0x5C && bite !== 0x7E) {
          // Unset the iso-2022-jp output flag and return a code point
          // whose value is byte.
          this.iso2022jp_output_flag = false;
          return bite;
