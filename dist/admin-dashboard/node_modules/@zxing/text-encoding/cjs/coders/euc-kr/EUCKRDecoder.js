...
var EUCKRDecoder = /** @class */function () {
  ...
  EUCKRDecoder.prototype.handler = function (stream, bite) {
    ...
    // finished.
    if (bite === terminology_1.end_of_stream && this.euckr_lead === 0) return finished_1.finished;
    ...
    if (this.euckr_lead !== 0x00) {
      ...
      if (utilities_1.inRange(bite, 0x41, 0xFE)) pointer = (lead - 0x81) * 190 + (bite - 0x41);
      // 2. Let code point be null, if pointer is null, and the
      // index code point for pointer in index euc-kr otherwise.
      var code_point = pointer === null ? null : indexes_1.indexCodePointFor(pointer, indexes_1.index('euc-kr'));
      // 3. If code point is null and byte is an ASCII byte, prepend
      // byte to stream.
      if (pointer === null && terminology_1.isASCIIByte(bite)) stream.prepend(bite);
