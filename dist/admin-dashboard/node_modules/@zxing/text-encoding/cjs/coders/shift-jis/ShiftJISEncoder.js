...
var ShiftJISEncoder = /** @class */function () {
  ...
  ShiftJISEncoder.prototype.handler = function (stream, code_point) {
    ...
    if (code_point === terminology_1.end_of_stream) return finished_1.finished;
    // 2. If code point is an ASCII code point or U+0080, return a
    // byte whose value is code point.
    if (terminology_1.isASCIICodePoint(code_point) || code_point === 0x0080) return code_point;
    ...
    if (utilities_1.inRange(code_point, 0xFF61, 0xFF9F)) return code_point - 0xFF61 + 0xA1;
