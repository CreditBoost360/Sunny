...
var UTF16Decoder = /** @class */function () {
  ...
  UTF16Decoder.prototype.handler = function (stream, bite) {
    ...
    if (bite === terminology_1.end_of_stream && (this.utf16_lead_byte !== null || this.utf16_lead_surrogate !== null)) {
    ...
    // return error.
    if (utilities_1.inRange(code_unit, 0xDC00, 0xDFFF)) return encodings_1.decoderError(this.fatal);
