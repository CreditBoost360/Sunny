...
var Big5Decoder = /** @class */function () {
  ...
  Big5Decoder.prototype.handler = function (stream, bite) {
    ...
    // finished.
    if (bite === terminology_1.end_of_stream && this.Big5_lead === 0x00) return finished_1.finished;
    ...
    if (this.Big5_lead !== 0x00) {
      ...
      // (byte − offset).
      if (utilities_1.inRange(bite, 0x40, 0x7E) || utilities_1.inRange(bite, 0xA1, 0xFE)) pointer = (lead - 0x81) * 157 + (bite - offset);
      ...
      var code_point = pointer === null ? null : indexes_1.indexCodePointFor(pointer, indexes_1.index('big5'));
