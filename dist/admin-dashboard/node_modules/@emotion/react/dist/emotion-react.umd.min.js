!function (e, t) {
  "object" == typeof exports && "undefined" != typeof module ? t(exports, require("react")) : "function" == typeof define && define.amd ? define(["exports", "react"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).emotionReact = {}, e.React);
}(this, function (e, t) {
  "use strict";
  ...
  function P(e, t) {
    return h(A("", null, null, "", null, null, 0), e, {
      length: -e.length
    }, t);
  }
  function j() {
  ...
  function X(e, t, r, n, a, o, s, c, i) {
    for (var u = 0, f = 0, l = s, p = 0, h = 0, y = 0, b = 1, x = 1, S = 1, C = 0, k = "", O = a, E = o, _ = n, A = k; x;) switch (y = C, C = T()) {
      case 40:
        if (108 != y && 58 == g(A, l - 1)) {
          -1 != v(A += m(I(C), "&", "&\f"), "&\f") && (S = -1);
          break;
      ...
      case 0:
        switch (C) {
          ...
          case 125:
            x = 0;
          case 59 + f:
            -1 == S && (A = m(A, /\f/g, "")), h > 0 && w(A) - l && $(h > 32 ? V(A + ";", n, r, l - 1) : V(m(A, " ", "") + ";", n, r, l - 2), i);
            break;
          case 59:
            A += ";";
          default:
            if ($(_ = B(A, t, r, u, f, a, c, k, O = [], E = [], l), o), 123 === C) if (0 === f) X(A, t, _, _, O, o, l, c, E);else switch (99 === p && 110 === g(A, 3) ? 100 : p) {
              case 100:
              case 108:
              case 109:
              case 115:
      ...
      case 58:
        l = 1 + w(A), h = y;
      default:
        if (b < 1) if (123 == C) --b;else if (125 == C && 0 == b++ && 125 == j()) continue;
        switch (A += d(C), C * b) {
          case 38:
            S = f > 0 ? 1 : (A += "\f", -1);
            break;
  ...
  function B(e, t, r, n, a, o, s, c, i, f, l) {
    for (var d = a - 1, h = 0 === a ? o : [""], v = x(h), g = 0, w = 0, $ = 0; g < n; ++g) for (var S = 0, C = b(e, d + 1, d = p(w = s[g])), k = e; S < v; ++S) (k = y(w > 0 ? h[S] + " " + C : m(C, /&\f/g, h[S]))) && (i[$++] = k);
    ...
    ne = function (e) {
      if ("rule" === e.type && e.parent && !(e.length < 1)) {
        ...
        if ((1 !== e.props.length || 58 === t.charCodeAt(0) || re.get(r)) && !n) {
          re.set(e, !0);
          for (var a = [], o = te(t, a), s = r.props, c = 0, i = 0; c < o.length; c++) for (var u = 0; u < s.length; u++, i++) e.props[i] = a[c] ? o[c].replace(/&\f/g, s[u]) : s[u] + " " + o[c];
        }
      }
    },
    ae = function (e) {
      ...
      case 6444:
        switch (g(e, w(e) - 3 - (~v(e, "!important") && 10))) {
          case 107:
            return m(e, ":", ":" + c) + e;
          case 101:
            return m(e, /(.+:)([^;!]+)(;|!.+)?/, "$1" + c + (45 === g(e, 14) ? "inline-" : "") + "box$3$1" + c + "$2$3$1" + o + "$2box$3") + e;
        }
        break;
      case 5936:
        switch (g(e, t + 11)) {
  ...
  var se = [function (e, t, r, n) {
        ...
        case u:
          if (e.length) return function (e, t) {
            ...
            switch (function (e, t) {
              ...
              case ":read-write":
                return Y([P(e, {
                  props: [m(t, /:(read-\w+)/, ":" + s + "$1")]
                })], n);
              case "::placeholder":
                return Y([P(e, {
                  props: [m(t, /:(plac\w+)/, ":" + c + "input-$1")]
                }), P(e, {
                  props: [m(t, /:(plac\w+)/, ":" + s + "$1")]
                }), P(e, {
    ...
    ie = n.createContext("undefined" != typeof HTMLElement ? ce({
      key: "css"
    }) : null),
    ue = ie.Provider,
    fe = function (e) {
  ...
  var de = pe(function (e, t) {
    ...
    t.typeOf = w, t.AsyncMode = f, t.ConcurrentMode = l, t.ContextConsumer = u, t.ContextProvider = i, t.Element = n, t.ForwardRef = p, t.Fragment = o, t.Lazy = m, t.Memo = y, t.Portal = a, t.Profiler = c, t.StrictMode = s, t.Suspense = d, t.isValidElementType = function (e) {
      return "string" == typeof e || "function" == typeof e || e === o || e === l || e === c || e === s || e === d || e === h || "object" == typeof e && null !== e && (e.$$typeof === m || e.$$typeof === y || e.$$typeof === i || e.$$typeof === u || e.$$typeof === p || e.$$typeof === v || e.$$typeof === g || e.$$typeof === b);
  ...
  var Me = {
    ...
    Le = function (e, t) {
      switch (e) {
        case "animation":
        case "animationName":
          if ("string" == typeof t) return t.replace(Fe, function (e, t, r) {
            return He = {
              name: t,
              styles: r,
              next: He
    ...
    We = "Component selectors can only be used in conjunction with @emotion/babel-plugin, the swc Emotion plugin, or another Emotion-aware compiler transform.";
  function qe(e, t, r) {
    if (null == r) return "";
    var n = r;
    ...
    switch (typeof r) {
      ...
      case "object":
        ...
        return function (e, t, r) {
          var n = "";
          if (Array.isArray(r)) for (var a = 0; a < r.length; a++) n += qe(e, t, r[a]) + ";";else for (var o in r) {
            var s = r[o];
            if ("object" != typeof s) {
              var c = s;
  ...
  var Be,
    ...
    et = fe(function (e, t, r) {
      ...
      return u.className = c, r && (u.ref = r), n.createElement(n.Fragment, null, n.createElement(Qe, {
        cache: t,
        serialized: i,
  ...
  }, Be = e.jsx || (e.jsx = {}), Ue || (Ue = Be.JSX || (Be.JSX = {}));
  var tt = fe(function (e, t) {
    ...
    return Ze(function () {
      ...
      return t.sheet.tags.length && (n.before = t.sheet.tags[0]), null !== s && (o = !0, s.setAttribute("data-emotion", e), n.hydrate([s])), a.current = [n, o], function () {
        n.flush();
      };
    }, [t]), Ze(function () {
      var e = a.current,
      ...
      if (null != o) {
        ...
        switch (typeof o) {
          case "boolean":
            break;
          case "object":
            if (Array.isArray(o)) s = e(o);else for (var c in s = "", o) o[c] && c && (s && (s += " "), s += c);
            break;
          default:
            s = o;
        }
  ...
  var at = function (e) {
    ...
    ot = fe(function (e, t) {
      var r = [],
        ...
        s = e.children(o);
      return !0, n.createElement(n.Fragment, null, n.createElement(at, {
        cache: t,
        serializedArr: r
      }), s);
    });
  e.CacheProvider = ue, e.ClassNames = ot, e.Global = tt, e.ThemeContext = _e, e.ThemeProvider = function (e) {
    var t = n.useContext(_e);
    return e.theme !== t && (t = Ae(t)(e.theme)), n.createElement(_e.Provider, {
      value: t
    }, e.children);
  }, e.__unsafe_useEmotionCache = function () {
    return t.useContext(ie);
  }, e.createElement = e.jsx, e.css = rt, e.keyframes = function () {
  ...
  }, e.withEmotionCache = fe, e.withTheme = function (e) {
