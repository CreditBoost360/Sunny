!function (e, t) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = t(require("@emotion/react"), require("react")) : "function" == typeof define && define.amd ? define(["@emotion/react", "react"], t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).emotionStyled = t(e.emotionReact, e.React);
}(this, function (e, t) {
  "use strict";
    ...
    switch (typeof r) {
      ...
      case "object":
        ...
        return function (e, t, r) {
          var n = "";
          if (Array.isArray(r)) for (var i = 0; i < r.length; i++) n += h(e, t, r[i]) + ";";else for (var o in r) {
            var a = r[o];
            if ("object" != typeof a) {
              var s = a;
  ...
  var b = function (e, t, r) {
    ...
    O = function t(r, o) {
      ...
      return function () {
        ...
        if (void 0 !== a && m.push("label:" + a + ";"), null == f[0] || void 0 === f[0].raw) m.push.apply(m, f);else {
          var v = f[0];
          m.push(v[0]);
        ...
        var x = e.withEmotionCache(function (t, r, i) {
          ...
          "string" == typeof t.className ? (o = r.registered, a = k, s = t.className, f = "", s.split(" ").forEach(function (e) {
            void 0 !== o[e] ? a.push(o[e] + ";") : e && (f += e + " ");
          }), b = f) : null != t.className && (b = t.className + " ");
          ...
          return A.className = b, i && (A.ref = i), n.createElement(n.Fragment, null, n.createElement(S, {
            cache: r,
            serialized: _,
            isStringTag: "string" == typeof v
          }), n.createElement(v, A));
        });
        return x.displayName = void 0 !== a ? a : "Styled(" + ("string" == typeof c ? c : c.displayName || c.name || "Component") + ")", x.defaultProps = r.defaultProps, x.__emotion_real = x, x.__emotion_base = c, x.__emotion_styles = m, x.__emotion_forwardProp = d, Object.defineProperty(x, "toString", {
          value: function () {
            return "." + l;
          }
        }), x.withComponent = function (e, r) {
          return t(e, i({}, o, r, {
            shouldForwardProp: _(x, r, !0)
          })).apply(void 0, m);
        }, x;
      };
    }.bind(null);
