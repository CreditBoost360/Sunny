 ...
 */
var CardPaymentForm = function CardPaymentForm(_ref) {
  ...
  var _useState = (0, _react.useState)({
      ...
      expYear: '',
      cvv: '',
      holderName: (customer === null || customer === void 0 ? void 0 : customer.name) || ''
    }),
  ...
  var validateForm = function validateForm() {
    ...
    var currentYear = new Date().getFullYear() % 100; // Get last 2 digits of year
    if (!cardDetails.expYear || !/^\d{2}$/.test(cardDetails.expYear) || parseInt(cardDetails.expYear) < currentYear) {
  ...
  var handleCardNumberChange = function handleCardNumberChange(e) {
  ...
  }, "Pay ", currency, " ", amount), sdkError && /*#__PURE__*/_react["default"].createElement("p", {
    className: "mt-2 text-sm text-red-600"
  }, sdkError.message)), /*#__PURE__*/_react["default"].createElement("div", {
    className: "mt-4 text-center"
  }, /*#__PURE__*/_react["default"].createElement("p", {
    className: "text-xs text-gray-500"
  }, "Your payment is secure. We use encryption to protect your data.")));
};
var _default = exports["default"] = CardPaymentForm;