...
/**
 * Dashboard layout component with improved responsive behavior
 */
const DashboardLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Transactions', href: '/dashboard/transactions', icon: TransactionIcon, current: false },
    { name: 'Payments', href: '/dashboard/payments', icon: PaymentIcon, current: false },
    { name: 'Customers', href: '/dashboard/customers', icon: CustomerIcon, current: false },
